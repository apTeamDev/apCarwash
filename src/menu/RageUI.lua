...
print(
	"^0___________________________________________________________________________^0\n" ..
	"^0[^1Create By^0]^7 :^0 ^1TeamAnarchyDev [Shimiotsuki]^0\n" ..
	"^0[^1Download^0]^7 :^0 ^1https://github.com/TeamAnarchyDev/Carwash-FiveM^0\n" ..
	"^0_______________________________________________________________________________^0"
)

print("[^1Create By ^0] : ^1 TeamAnarchyDev [Shimiotsuki]^0")
